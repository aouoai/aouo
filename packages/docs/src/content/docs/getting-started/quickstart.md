---
title: Quick Start
description: Install aouo, configure a provider and Telegram, then start the local runtime.
---
...
The dashboard runs on `127.0.0.1` and opens a URL with an ephemeral token. Use it for local configuration, status checks, and pack visibility.
